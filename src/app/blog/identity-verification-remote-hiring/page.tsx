                        ...
                        <div className="max-w-4xl mx-auto">
                            ...
                            <div className="prose prose-invert prose-lg max-w-none">
                                ...
                                <section className="mb-16">
                                    ...
                                    <p className="text-text-secondary mb-6">
                                        Verification isn&apos;t just about identifying bad actors—it's about protecting the <span className="text-white italic">true</span> candidates who spent years honing their skills. However, this level of analysis comes with a responsibility.
                                    </p>
                                ...
                                <section className="mb-16">
                                    <h2 className="text-3xl font-black text-white mb-8 tracking-tight">Why We Built the Integrity Evidence Layer</h2>
                                    <p className="text-text-secondary mb-8">
                                    ...
                                    <div className="p-10 rounded-[3rem] bg-gradient-to-br from-brand/10 to-transparent border border-brand/20 mb-16 text-center">
                                        ...
                                        <Link href="/pricing" className="inline-flex items-center gap-2 text-brand font-black uppercase tracking-widest text-xs hover:gap-4 transition-all">
                                            View Integrity Tiers <ArrowLeft className="w-4 h-4 rotate-180" />
                                        </Link>
                                    </div>
                                </section>
                            </div>
                            ...
                            <div className="mt-16 p-1 rounded-[2.5rem] bg-gradient-to-r from-brand/50 to-transparent">
                                <div className="bg-[#050505] p-10 md:p-16 rounded-[2.4rem] text-center">
                                    ...
                                    <p className="text-text-secondary mb-10 max-w-xl mx-auto text-lg">
                                        Don&apos;t leave your integrity to chance. Build evidence into every interview with our Integrity Evidence Layer.
                                    </p>
