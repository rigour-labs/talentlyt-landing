                    ...
                    <article className="px-4 sm:px-6 py-12">
                        <div className="max-w-4xl mx-auto">
                            ...
                            <div className="prose prose-invert prose-lg max-w-none">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
                                        <div className="p-8 rounded-3xl bg-white/[0.02] border border-white/5 group hover:border-brand/30 transition-all">
                                            ...
                                            <p className="text-sm text-text-secondary leading-relaxed">
                                                Does the candidate&apos;s speaking speed match their coding speed? Proxy actors often types in &quot;bursts&quot; (copy-paste) while trying to maintain a slow, conversational dialogue. This dissonance is a primary integrity signal.
                                            </p>
                                        </div>
                                        <div className="p-8 rounded-3xl bg-white/[0.02] border border-white/5 group hover:border-brand/30 transition-all">
                                ...
                                <section className="mb-16">
                                    <h2 className="text-3xl font-black text-white mb-8 tracking-tight">Advanced Verification Strategies</h2>
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        <div className="flex gap-4 p-8 rounded-[2rem] bg-card border border-white/5">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-sm text-text-secondary leading-relaxed">Our <strong>Integrity Evidence Layer</strong> injects non-obvious technical probes into the interview. These verify whether the candidate genuinely understands their own work, revealing depth that a surface-level assessment would miss.</p>
                                            </div>
                                        </div>
                                    </div>
                                </section>
                                ...
                                <section className="mb-16">
                                    ...
                                    <div className="p-8 rounded-3xl bg-blue-500/5 border border-blue-500/20 mb-8">
                                        <p className="text-sm text-text-secondary margin-0">
                                            <strong className="text-white">The Integrity Promise:</strong> We do not track keystrokes outside the interview environment. We do not use &quot;black-box&quot; scoring. If an integrity signal is raised, we provide a detailed evidence report explaining <em>exactly</em> which signal triggered the alert, allowing for human review and rebuttal. Fairness is our primary metric.
                                        </p>
                                    </div>
                                </section>
                                ...
                                <section className="mb-16">
                                    ...
                                    <p className="text-text-secondary leading-relaxed">
                                        In technical hiring, trust is expensive. It must be earned through verified skill and identity. By deploying an evidence-first integrity layer, you don&apos;t just close verification gaps—you protect your team&apos;s time and your company&apos;s long-term engineering excellence.
                                    </p>
                                </section>
                            </div>
                            ...
                            <div className="mt-16 p-10 md:p-16 rounded-[4rem] bg-gradient-to-br from-red-500/10 to-transparent border border-red-500/20 text-center">
                                ...
                                <p className="text-text-secondary mb-10 max-w-xl mx-auto text-lg leading-relaxed">
                                    Don&apos;t let verification gaps undermine your engineering quality. Build integrity evidence into every interview with evidence-grade verification.
                                </p>
                                <Link
                                    href="/request-demo"
                                    className="inline-flex items-center justify-center gap-3 px-10 py-5 bg-brand text-white font-black rounded-2xl hover:bg-brand-hover transition-all uppercase tracking-widest text-xs shadow-2xl shadow-brand/30"
                                >
                                    Build Evidence Now <ArrowLeft className="w-4 h-4 rotate-180" />
                                </Link>
                            </div>
                        </div>
                    </article>
