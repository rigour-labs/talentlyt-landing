...
export const metadata: Metadata = {
    ...
    description: 'Remote hiring lacks evidence. Discover verification strategies to document candidate authenticity and AI collaboration patterns while maintaining candidate dignity and legal compliance.',
    keywords: [
    ...
    openGraph: {
        title: 'The Trust Crisis: Why Interview Integrity Is the New Technical Standard',
        description: 'Verification reality check: How to build integrity evidence into your technical hiring funnel.',
        type: 'article',
                            ...
                            <div className="prose prose-invert prose-lg max-w-none">
                                <section className="mb-16">
                                    <p className="text-text-secondary mb-6">
                                        The dirty secret of modern technical hiring is that it has never been easier to game. While we celebrate the accessibility of remote work, we must also acknowledge the elephant in the Zoom room: <strong>the Integrity Gap.</strong>
                                    </p>
                                    <p className="text-text-secondary mb-6">
                                ...
                                <section className="mb-16">
                                    <h2 className="text-3xl font-black text-white mb-8 tracking-tight">Three Verification Gaps in Modern Hiring</h2>
                                    <p className="text-text-secondary mb-10">
                                        Verification gaps today aren&apos;t just a candidate glancing at a second monitor. They represent a multi-layered challenge to your hiring funnel.
                                    </p>
                                ...
                                <section className="mb-16">
                                    ...
                                    <p className="text-text-secondary mb-8">
                                        To build reliable evidence, we look for <strong>behavioral and technical inconsistencies.</strong> Our Integrity Evidence Layer analyzes 15 signal layers that are difficult to replicate simultaneously:
                                    </p>
                                    <div className="space-y-6">
                                        <div className="flex gap-4 p-6 rounded-2xl bg-white/[0.01] border border-white/5">
                                            ...
                                            <p className="text-text-secondary"><strong className="text-white">Audio-Visual Synchronization:</strong> Documenting mismatches between what a candidate says and how their face moves — a key indicator for identity verification.</p>
                                        </div>
                                        <div className="flex gap-4 p-6 rounded-2xl bg-white/[0.01] border border-white/5">
                                            <div className="w-2 h-2 rounded-full bg-brand mt-2.5" />
                                        ...
                                        <div className="flex gap-4 p-6 rounded-2xl bg-white/[0.01] border border-white/5">
                                            <div className="w-2 h-2 rounded-full bg-brand mt-2.5" />
                                            <p className="text-text-secondary"><strong className="text-white">Behavioral Pattern Analysis:</strong> Documenting patterns that correlate with external assistance, AI collaboration style, or inconsistent engagement.</p>
                                        </div>
                                    </div>
                                </section>
                                ...
                                <section className="mb-16">
                                    ...
                                    <p className="text-text-secondary leading-relaxed">
                                        A verified session doesn&apos;t just close gaps; it produces a <strong className="text-white">validated job success prediction</strong> and a signed, portable profile that travels with the candidate. This is how we ensure that trust scales across the entire technical ecosystem.
                                    </p>
                                </section>
                            </div>
                            ...
                            <div className="mt-16 p-1 rounded-[2.5rem] bg-gradient-to-r from-brand/50 to-brand/20">
                                <div className="bg-[#050505] p-10 md:p-16 rounded-[2.4rem] text-center">
                                    ...
                                    <p className="text-text-secondary mb-10 max-w-xl mx-auto text-lg">
                                        Don&apos;t wait for a $100k bad hire to take integrity seriously. Deploy our Integrity Evidence Layer today.
                                    </p>
