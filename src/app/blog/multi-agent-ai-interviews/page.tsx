...
export const metadata: Metadata = {
    ...
    description: "One AI model isn't enough. Discover how multi-agent systems create a checks and balances architecture to ensure accuracy and integrity in technical interviews.",
    keywords: [
        ...
        'integrity evidence architecture'
    ],
    openGraph: {
        title: 'Consensus in the Machine: Why Multi-Agent AI is the Future of Hiring',
        description: 'How multi-agent systems ensure accurate and integrity-verified technical assessments through consensus.',
        type: 'article',
