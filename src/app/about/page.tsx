                ...
                <div className="max-w-5xl mx-auto">
                    ...
                    >
                        ...
                        <p className="text-xl text-text-secondary max-w-3xl mx-auto leading-relaxed">
                            TalentLyt was born from a simple frustration: hiring is broken. Bad hires cost teams time, money, and morale. We're fixing that with AI that doesn't just screen—it verifies.
                        </p>
                    </motion.div>
                    ...
                    >
                        ...
                        <p className="text-xl text-text-secondary leading-relaxed">
                            To make every technical hire a <span className="text-white font-semibold">verified hire</span>. We combine conversational AI with forensic integrity monitoring to ensure companies hire people who can actually do the job—and candidates get a fair, unbiased assessment of their skills.
                        </p>
                    </motion.section>
                    ...
                    >
                        ...
                        <p className="text-text-secondary mb-4">
                            TalentLyt is a product of Rigour Labs Inc., a Delaware-incorporated company focused on building trust infrastructure for the AI era.
                        </p>
