...
import { Check, Info, ShieldCheck, Zap, Globe, MessageSquare, ArrowRight } from 'lucide-react';
        ...
        <div className="min-h-screen bg-background flex flex-col pt-20">
            ...
            <main className="flex-1 py-16 px-4 sm:px-6 lg:px-8">
                <div className="max-w-7xl mx-auto">
                    ...
                    {/* Interview Packs - Pre-paid Savings */}
                    <section className="mb-20">
                        <div className="text-center mb-12">
                            <h2 className="text-3xl font-bold mb-4">Pre-Paid Interview Packs</h2>
                            <p className="text-text-secondary">Buy in bulk for seasonal hiring or budget predictability. Packs are valid for 12 months.</p>
                        </div>
                    ...
                    <section className="mb-20">
                        <div className="text-center mb-12">
                            ...
                            <p className="text-text-secondary">Tailor the platform to your specific enterprise requirements.</p>
                        </div>
                            ...
                            {[
                                {
                                    ...
                                    a: "Each plan comes with a base number of interviews. If you exceed this, you're charged at a per-interview overage rate. This allows you to scale during peak hiring seasons without moving up a plan permanently."
                                },
                                {
                                    q: "Do you offer custom agent personas?",
                                    a: "Yes, on our Enterprise plan, we can fine-tune Maya's persona, knowledge base, and tone to perfectly match your company's hiring style and culture."
                                },
                                {
                                    q: "Is candidate data encrypted?",
                                    a: "Absolutely. All session data, recordings, and transcripts are encrypted at rest (AES-256) and in transit (TLS 1.3). We are GDPR and DPDPA compliant."
                                },
                                {
                                    q: "Can I cancel my subscription anytime?",
                                    a: "Yes, you can cancel at the end of any billing cycle. We don't believe in locking you into contracts that don't provide value."
                                }
                            ].map((faq, i) => (
