...
export const metadata: Metadata = {
    ...
    keywords: [
        ...
        'MENA hiring platform',
        'UAE tech hiring',
        'remote candidate verification UAE',
        'Dubai staffing technology',
        'GCC recruitment AI',
        'Abu Dhabi hiring tech',
        'Middle East interview platform',
        'UAE startup hiring',
        'recruitment agency UAE',
        'technical screening Dubai',
    ],
    openGraph: {
        title: 'Rigovo UAE | AI Interview Platform for UAE & MENA Hiring',
