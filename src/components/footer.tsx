        ...
        <footer className="py-12 sm:py-16 px-4 sm:px-6 border-t border-border bg-background" role="contentinfo">
            <div className="max-w-7xl mx-auto">
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-8 mb-12">
                    ...
                    <nav className="flex flex-wrap items-center justify-center gap-4 sm:gap-6 md:gap-8 text-xs sm:text-sm text-white/70" aria-label="Footer navigation">
                        <FooterLink
                            href="/about"
                ...
                <div className="text-center py-8 border-t border-white/5 mt-8">
                    ...
                    <p className="text-xs text-white/60 mt-2">
                        ...
                        <FooterLink
                            href="/security"
                            className="text-white/80 underline hover:text-brand transition-colors focus:outline-none focus:ring-2 focus:ring-brand focus:ring-offset-2 focus:ring-offset-background rounded"
                        >
                            Security & Compliance
                        </FooterLink>
                        ,{' '}
                ...
                <div className="border-t border-white/5 mt-8 pt-10 flex flex-col md:flex-row justify-between items-center gap-6">
                    <div className="flex flex-col items-center md:items-start">
                        <p className="technical-label text-xs text-white/60">
                            © {new Date().getFullYear()} Rigour Labs. All rights reserved.
                        </p>
                    </div>
                    ...
                    <div className="flex flex-wrap items-center justify-center gap-4 md:gap-6">
                        <div className="flex items-center gap-2 px-3 py-1.5 rounded-lg bg-white/5 border border-white/10">
                            ...
                            <span className="text-xs font-bold text-white/80 uppercase tracking-wider">SOC2 Ready</span>
                        </div>
                        <div className="flex items-center gap-2 px-3 py-1.5 rounded-lg bg-white/5 border border-white/10">
                            <svg className="w-4 h-4 text-blue-500" fill="currentColor" viewBox="0 0 20 20">
                                <path fillRule="evenodd" d="M5 9V7a5 5 0 0110 0v2a2 2 0 012 2v5a2 2 0 01-2 2H5a2 2 0 01-2-2v-5a2 2 0 012-2zm8-2v2H7V7a3 3 0 016 0z" clipRule="evenodd" />
                            </svg>
                            <span className="text-xs font-bold text-white/80 uppercase tracking-wider">GDPR Compliant</span>
                        </div>
                        <div className="flex items-center gap-2 px-3 py-1.5 rounded-lg bg-white/5 border border-white/10">
                            <svg className="w-4 h-4 text-purple-500" fill="currentColor" viewBox="0 0 20 20">
                                <path fillRule="evenodd" d="M18 8a6 6 0 01-7.743 5.743L10 14l-1 1-1 1H6v2H2v-4l4.257-4.257A6 6 0 1118 8zm-6-4a1 1 0 100 2 2 2 0 012 2 1 1 0 102 0 4 4 0 00-4-4z" clipRule="evenodd" />
                            </svg>
                            <span className="text-xs font-bold text-white/80 uppercase tracking-wider">AES-256</span>
                        </div>
                    </div>
                </div>
            </div>
