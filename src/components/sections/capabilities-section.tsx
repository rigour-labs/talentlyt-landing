...
const capabilities = [
    ...
    {
        title: 'Sentinel Integrity Engine',
        description: '15 signals run silently throughout every interview — catching proxy candidates, deepfakes, and impersonation attempts that phone screens can\u2019t detect.',
        metric: '6,824 signals caught in beta',
        icon: Shield,
        className: 'md:col-span-1',
    },
    {
        title: 'AI Architect vs. Passenger',
        description: 'We don\u2019t just detect AI usage — we classify whether candidates lead AI or follow it. Hire people who understand the tech, not just prompt it.',
    ...
    {
        title: 'Video Scan',
        description: 'Already have recorded interviews from Zoom or Teams? Upload them and we\'ll run a forensic integrity analysis — deepfakes, identity fraud, and authenticity verification.',
        metric: '$35 per scan',
        icon: Cpu,
        className: 'md:col-span-1',
    },
